...
def maxquant_inference(protein_ids, peptide_seq):
    '''Creates a relationship mapping protein IDs to peptide IDs. This is the raw mapping 
    given by MaxQuant (is not well validated or curated).'''
